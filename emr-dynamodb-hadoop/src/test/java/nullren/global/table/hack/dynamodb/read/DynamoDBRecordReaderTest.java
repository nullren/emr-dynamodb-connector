...
public class DynamoDBRecordReaderTest {
  ...
  public void testPaginatedReads() {
    DynamoDBSplit
      split = new DynamoDBSegmentsSplit(null, 0, 0, Arrays.asList(0), 4, new
      DynamoDBQueryFilter());
    ...
    context.setClient(new DynamoDBClient() {
      ...
      @Override
      public DynamoDBFibonacciRetryer.RetryResult<ScanResult> scanTable(String tableName, DynamoDBQueryFilter
        ...
        if (i == 0) {
          ...
          i++;
          return new DynamoDBFibonacciRetryer.RetryResult<>(new ScanResult().withScannedCount(items.size())
  ...
  public void testConsumingRemainingElementsIfEndKeyIsNull() {
    ...
    context.setClient(new DynamoDBClient() {
      ...
      public DynamoDBFibonacciRetryer.RetryResult<ScanResult> scanTable(String tableName, DynamoDBQueryFilter
          dynamoDBQueryFilter, Integer segment, Integer totalSegments, Map<String,
          AttributeValue> exclusiveStartKey, long limit, Reporter reporter) {
        return new DynamoDBFibonacciRetryer.RetryResult<>(getHashNumberRangeKeyItems(HASH_KEYS, "S"), 0);
      }
    });
  ...
  public void testScanFirstSegment() {
    ...
    context.setClient(new DynamoDBClient() {
      ...
      public DynamoDBFibonacciRetryer.RetryResult<ScanResult> scanTable(String tableName, DynamoDBQueryFilter
        ...
        return new DynamoDBFibonacciRetryer.RetryResult<>(getHashKeyItems(HASH_KEYS), 0);
      }
    });
