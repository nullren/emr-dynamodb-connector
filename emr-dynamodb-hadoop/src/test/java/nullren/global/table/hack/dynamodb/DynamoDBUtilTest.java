...
public class DynamoDBUtilTest {
  ...
  public void testGetBoundedBatchLimit() {
    Assert.assertEquals(1, DynamoDBUtil.getBoundedBatchLimit(conf, 0));
    Assert.assertEquals(1, DynamoDBUtil.getBoundedBatchLimit(conf, 1));
    Assert.assertEquals(DynamoDBConstants.DEFAULT_MAX_ITEMS_PER_BATCH,
        DynamoDBUtil.getBoundedBatchLimit(conf, DynamoDBConstants.DEFAULT_MAX_ITEMS_PER_BATCH + 1));
    Assert.assertEquals(DynamoDBConstants.DEFAULT_MAX_ITEMS_PER_BATCH,
        DynamoDBUtil.getBoundedBatchLimit(conf, DynamoDBConstants.DEFAULT_MAX_ITEMS_PER_BATCH));
  }
}
