...
import nullren.global.table.hack.dynamodb.util.AbstractTimeSource;
import nullren.global.table.hack.dynamodb.util.MockTimeSource;
...
public class ReadManagerTest {
  ...
  private static class MockReadWorker extends ReadWorker {
    ...
    private void read(RateController.RequestLimit lim) {
      state = STATE.READING;
