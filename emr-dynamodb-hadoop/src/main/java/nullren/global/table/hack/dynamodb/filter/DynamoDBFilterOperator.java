...
package nullren.global.table.hack.dynamodb.filter;
...
public enum DynamoDBFilterOperator {
  ...
  EQ(DynamoDBFilterOperatorType.BINARY, "=", DynamoDBFilterOperatorConstants.UDF_OP_PREFIX + "Equal", "EQ", 1),
  ...
  LE(DynamoDBFilterOperatorType.BINARY, "<=", DynamoDBFilterOperatorConstants.UDF_OP_PREFIX + "EqualOrLessThan", "LE", 4),
  GE(DynamoDBFilterOperatorType.BINARY, ">=", DynamoDBFilterOperatorConstants.UDF_OP_PREFIX + "EqualOrGreaterThan", "GE", 5),
  LT(DynamoDBFilterOperatorType.BINARY, "<", DynamoDBFilterOperatorConstants.UDF_OP_PREFIX + "LessThan", "LT", 6),
  GT(DynamoDBFilterOperatorType.BINARY, ">", DynamoDBFilterOperatorConstants.UDF_OP_PREFIX + "GreaterThan", "GT", 7),
  NE(DynamoDBFilterOperatorType.BINARY, "<>", DynamoDBFilterOperatorConstants.UDF_OP_PREFIX + "NotEqual", "NE", 8),
  N_NULL(DynamoDBFilterOperatorType.UNARY, "isnull", DynamoDBFilterOperatorConstants.UDF_OP_PREFIX + "NotNull", "NOT_NULL", 9),
  NULL(DynamoDBFilterOperatorType.UNARY, "isnotnull", DynamoDBFilterOperatorConstants.UDF_OP_PREFIX + "Null", "NULL", 10);
