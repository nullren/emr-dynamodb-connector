...
package nullren.global.table.hack.dynamodb.write;
...
import nullren.global.table.hack.dynamodb.DynamoDBOperationType;
import nullren.global.table.hack.dynamodb.DynamoDBUtil;
import nullren.global.table.hack.dynamodb.IopsCalculator;
import nullren.global.table.hack.dynamodb.IopsController;
...
public abstract class AbstractDynamoDBRecordWriter<K, V> implements RecordWriter<K, V> {
  ...
  public AbstractDynamoDBRecordWriter(JobConf jobConf, Progressable progressable) {
    ...
    IopsCalculator
      iopsCalculator = new WriteIopsCalculator(DynamoDBUtil.createJobClient(jobConf), client,
        tableName);
