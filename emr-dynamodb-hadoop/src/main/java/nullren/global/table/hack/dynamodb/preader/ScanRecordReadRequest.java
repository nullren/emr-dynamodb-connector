...
import nullren.global.table.hack.dynamodb.preader.RateController.RequestLimit;
...
public class ScanRecordReadRequest extends AbstractRecordReadRequest {
  ...
  protected PageResults<Map<String, AttributeValue>> fetchPage(RequestLimit lim) {
    // Read from DynamoDB
    DynamoDBFibonacciRetryer.RetryResult<ScanResult>
      retryResult = context.getClient().scanTable(tableName, null, segment,
