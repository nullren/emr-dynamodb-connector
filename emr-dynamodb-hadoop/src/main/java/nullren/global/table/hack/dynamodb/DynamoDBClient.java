...
package nullren.global.table.hack.dynamodb;
...
import nullren.global.table.hack.dynamodb.DynamoDBFibonacciRetryer.RetryResult;
...
public class DynamoDBClient {
  ...
  public DynamoDBClient() {
    dynamoDB = null;
    config = null;
    maxBatchSize = DynamoDBConstants.DEFAULT_MAX_BATCH_SIZE;
    maxItemByteSize = DynamoDBConstants.DEFAULT_MAX_ITEM_SIZE;
  }
  ...
  public DynamoDBClient(Configuration conf, String region) {
    ...
    maxBatchSize = config.getLong(DynamoDBConstants.MAX_BATCH_SIZE, DynamoDBConstants.DEFAULT_MAX_BATCH_SIZE);
    maxItemByteSize = config.getLong(DynamoDBConstants.MAX_ITEM_SIZE, DynamoDBConstants.DEFAULT_MAX_ITEM_SIZE);
  }
            ...
            if (unprocessedItems == null || unprocessedItems.isEmpty()) {
              ...
              for (List<WriteRequest> unprocessedWriteRequests : unprocessedItems.values()) {
                ...
                long maxItemsPerBatch =
                    config.getLong(DynamoDBConstants.MAX_ITEMS_PER_BATCH, DynamoDBConstants.DEFAULT_MAX_ITEMS_PER_BATCH);
                long maxBatchSize = config.getLong(DynamoDBConstants.MAX_BATCH_SIZE, DynamoDBConstants.DEFAULT_MAX_BATCH_SIZE);
