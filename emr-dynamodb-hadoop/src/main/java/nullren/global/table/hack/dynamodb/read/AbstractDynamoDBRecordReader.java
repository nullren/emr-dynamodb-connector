...
package nullren.global.table.hack.dynamodb.read;

import com.amazonaws.services.dynamodbv2.model.AttributeValue;

import nullren.global.table.hack.dynamodb.DynamoDBClient;
import nullren.global.table.hack.dynamodb.DynamoDBConstants;
import nullren.global.table.hack.dynamodb.DynamoDBUtil;
import nullren.global.table.hack.dynamodb.IopsCalculator;
import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import nullren.global.table.hack.dynamodb.DynamoDBItemWritable;
import nullren.global.table.hack.dynamodb.preader.AbstractReadManager;
import nullren.global.table.hack.dynamodb.preader.DynamoDBRecordReaderContext;
import nullren.global.table.hack.dynamodb.preader.PageResultMultiplexer;
import nullren.global.table.hack.dynamodb.preader.QueryReadManager;
import nullren.global.table.hack.dynamodb.preader.RateController;
import nullren.global.table.hack.dynamodb.preader.ScanReadManager;
import nullren.global.table.hack.dynamodb.split.DynamoDBSplit;
import nullren.global.table.hack.dynamodb.util.TimeSource;
...
public abstract class AbstractDynamoDBRecordReader<K, V> implements RecordReader<K, V> {
  ...
  private AbstractReadManager initReadManager() {
    ...
    IopsCalculator
      iopsCalculator = new ReadIopsCalculator(DynamoDBUtil.createJobClient(context.getConf()),
